...
public class Controller {
    ...
    public void setup(Stage primaryStage) {
        backgroundImage.fitWidthProperty().bind(workspacePanel.prefWidthProperty());
    ...
    public void findWindow() throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource
                ("/Resources/fxml/FindAndReplaceWindow.fxml"));
    ...
    public void findText() {
        ...
        if (occurances == 0)
            ...
            index = text.indexOf(word, getCurrentTextArea().getSelection().getEnd());
