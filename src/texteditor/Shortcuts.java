...
public class Shortcuts {
    ...
    public static void onLoad(Parent scene, Stage primaryStage, Controller controller) {
        ...
        KeyCombination selectAllShortcut = new KeyCodeCombination(KeyCode.A,KeyCodeCombination.CONTROL_DOWN);
        ...
        hotkeyFunctions.put(selectAllShortcut,"selectAll");
        ...
        shortcutList.add(selectAllShortcut);
